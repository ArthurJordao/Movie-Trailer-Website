...
def main():
    ...
    "A science fiction film about space travalling",
    ...
    divergent = Movie("Divergent", 
    "A filme about a future society",
    "https://upload.wikimedia.org/wikipedia/en/d/d4/Divergent.jpg",
    "https://www.youtube.com/watch?v=sutgWjz10sM")
    maze_runner = Movie("The Maze Runner", 
    "A filme about a society that lives in a maze",
    "https://upload.wikimedia.org/wikipedia/en/b/be/" + 
